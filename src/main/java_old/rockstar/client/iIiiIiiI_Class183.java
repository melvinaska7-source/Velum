...
public class iIiiIiiI_Class183
extends iIiIIIii_Class164 {
    public iIiiIiiI_Class183() {
        super("modules.settings.assist.plast", Items.DRIED_KELP.getDefaultStack(), iIIiIIii_Class148.i_field_88b781);
    }
