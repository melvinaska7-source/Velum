...
import pyvelum.events.network.SendPacketEvent;
...
import pyvelum.events.player.InputEvent;
import velum.client.GuiMoveModule;
import velum.client.IIiiiIIiI_Class115;
...
import velum.client.iIIIIIIii_Class260;
...
import velum.client.iIIiIiIiI_Class299;
import velum.client.iIIiIiIii_Class300;
import velum.client.iIIiiIiII_Class309;
import velum.client.iIIiiIiIi_Class310;
import velum.client.iIIiiiIiI_Class315;
...
extends Module {
    ...
    private final IiIIIiII_Class69<EventMotion> I_field_3d936f41 = eventMotion -> {
        if (this.i_field_500d0627.isSelected()) {
            VelumClient.getInstance().I_method_58785402().I_method_1acbf705(new iiIIiIIii_Class404(FlightModule.I_field_3a9bda27.player.getYaw(), 0.0f), iiIIiIIIi_Class402.i_field_32e0c64c, 180.0f, 180.0f, 180.0f, iiIIiIiiI_Class407.ii_field_32efc66c);
    ...
    private static iIIiIiIii_Class300 I_method_a6d97710(iIIiiIiII_Class309<iIIiIiIii_Class300> iIIiiIiII_Class3092) {
        ...
        for (iIIiIiIii_Class300 iIIiIiIii_Class3003 : iIIiiIiII_Class3092.I_method_617d3e68()) {
            ...
            if (itemStack.isEmpty() || !((item = itemStack.getItem()) instanceof ArmorItem) || ((iIiIiiIIi_Class346)(armorItem = (ArmorItem)item)).velum$getType() != EquipmentType.CHESTPLATE || (n2 = FlightModule.I_method_83c85be6(armorItem, itemStack)) <= n) continue;
            n = n2;
    ...
    private static int I_method_83c85be6(ArmorItem armorItem, ItemStack itemStack) {
        ...
        ArmorMaterial armorMaterial = ((iIiIiiIIi_Class346)armorItem).velum$getMaterial();
        EquipmentType equipmentType = ((iIiIiiIIi_Class346)armorItem).velum$getType();
    ...
    implements iIIiIIiIi_Class294 {
        ...
        private void I_method_8e875ac7() {
            ...
            GuiMoveModule iIIiIiIII_Class41 = VelumClient.getInstance().getModuleManager().getModule(GuiMoveModule.class);
        ...
        private void i_method_8e95e6a7() {
            if (this.I_field_5a) {
                VelumClient.getInstance().I_method_7897deab().i_method_f30f2128(this);
                this.I_field_5a = false;
            }
        }
