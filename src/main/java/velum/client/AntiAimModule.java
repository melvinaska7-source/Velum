...
extends Module {
    ...
    private void I_method_8f5a7ac0(BlockPos blockPos, Hand hand) {
        ...
        VelumClient.getInstance().I_method_58785402().I_method_1acbf705(iiIIiIIii_Class4042, iiIIiIIIi_Class402.Ii_field_32e0c64c, 45.0f, 45.0f, 45.0f, iiIIiIiiI_Class407.iI_field_32efc66c);
        iiIIiIIii_Class404 iiIIiIIii_Class4043 = VelumClient.getInstance().I_method_58785402().II_method_f098f858();
