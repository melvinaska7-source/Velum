...
import velum.client.IiIIIi_Class18;
import velum.client.IiIiIi_Class22;
import velum.client.iIiiIIiii_Class360;
import velum.client.iIiiIiiII_Class365;
...
implements IIiiii_Class16.Nested1_8a0e0776 {
    ...
    void II_method_79d0b542() {
        ...
        shaderProgram.addSamplerTexture("Sampler9", iiIiVelumClient2.I_method_a30f51ff());
        shaderProgram.addSamplerTexture("Sampler10", iiIiVelumClient2.i_method_a31ddddf());
        shaderProgram.addSamplerTexture("Sampler11", iiIiVelumClient2.II_method_bee9e6c8());
        for (int i = 0; i < 8; ++i) {
    ...
    private void I_method_4e4cea1a(String string, int n) {
        ...
        System.err.println("[Velum] Low-draw UI batching disabled after command texture " + string + " failure (OpenGL error " + n + ").");
    }
