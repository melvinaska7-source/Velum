   ...
   private static void I_method_4e8cc796(String var0) {
      try {
         ...
         if (var1.getName().endsWith(".rock")) {
            ...
            VelumClient.getInstance().I_method_5198232b().I_method_a9011662(var3, var2.getAsJsonObject());
         ...
         if (var1.getName().endsWith(".png") && Information.getPreferUser() != null) {
            ...
            HttpRequest var4 = HttpRequest.post("https://api.velum.moscow/minecraft/v1/auth/avatar.php");
