...
import velum.client.iIiIiiiii_Class352;
import velum.client.iIiiiIIII_Class369;
...
implements iIIiIIiIi_Class294 {
    ...
    private final IIIIII I_field_83aa0e21 = new IIIIII(VelumClient.id("rain_screen/data"));
