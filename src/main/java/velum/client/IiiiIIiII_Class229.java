...
extends IiiIiiIii_Class220<ModeSetting> {
    ...
    private void I_method_70ccc602(ModeSetting.Nested1_42765c60 nested1_42765c60) {
        ...
        nested1_42765c60.setEnablePenis(new iiIIIiiIi_Class398(VelumClient.id("penises/check_enable.penis")));
        nested1_42765c60.setDisablePenis(new iiIIIiiIi_Class398(VelumClient.id("penises/check_disable.penis")));
