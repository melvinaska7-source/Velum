...
import moscow.velum.mixin.accessors.FireworkRocketEntityAccessor;
...
extends Module {
    ...
    public void II_method_6642fd22() {
        ...
        VelumClient.getInstance().I_method_58785402().I_method_1acbf705(new iiIIiIIii_Class404(f2, f), iiIIiIIIi_Class402.i_field_32e0c64c, 25.0f, 1.0f, 2.0f, iiIIiIiiI_Class407.I_field_32efc66c);
    }
