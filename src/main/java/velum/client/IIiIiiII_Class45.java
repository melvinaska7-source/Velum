...
import velum.client.IiIIiiII_Class77;
...
public class IIiIiiII_Class45 {
    ...
    private void I_method_1930ab6d(IIIiiIii_Class28 iIIiiIii_Class28) {
        ...
        IiIIiiII_Class77 iiIIiiII_Class77 = VelumClient.getInstance().I_method_7a5acaeb();
    ...
    private void I_method_56ef18ec() {
        List<String> list = VelumClient.getInstance().I_method_7a5acaeb().I_method_dbf3f81b();
        if (list.isEmpty()) {
