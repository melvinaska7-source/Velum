...
import velum.client.IiiiiiIiI_Class251;
import velum.client.Iiiiiiiii_Class256;
...
extends Module {
    ...
    private iIIiIiIii_Class300 I_method_9f62035d(iIIiiIiII_Class309<iIIiIiIii_Class300> iIIiiIiII_Class3092) {
        ...
        for (iIIiIiIii_Class300 iIIiIiIii_Class3003 : iIIiiIiII_Class3092.I_method_617d3e68()) {
            ...
            if (itemStack.isEmpty() || !((item = itemStack.getItem()) instanceof ArmorItem) || ((iIiIiiIIi_Class346)(armorItem = (ArmorItem)item)).velum$getType() != EquipmentType.CHESTPLATE || (n2 = this.I_method_c584cef9(armorItem, itemStack)) <= n) continue;
            n = n2;
    ...
    private void Iii_method_49f452bf() {
        ...
        if (!bl && iIIiIiIii_Class3002 != null) {
            ...
            VelumClient.getInstance().I_method_5cb1af22().I_method_67864747(new iiiIiIi_Class118(IiIiIIII_Class81.I_method_1410d1e5("alerts.equipped", string), iIIiIiIii_Class3002.I_method_7b7e0bb9()).I_method_7ab92a7f(string));
            ...
            VelumClient.getInstance().I_method_5cb1af22().I_method_67864747(new iiiIiIi_Class118(IiIiIIII_Class81.I_method_1410d1e5("alerts.equipped", string), iIIiIiIii_Class3003.I_method_7b7e0bb9()).I_method_7ab92a7f(string));
        }
    }
