...
public class IiiiI_Class15 implements iIIiIIiIi_Class294, iIIiIIiii_Class296 {
   ...
   public void I_method_6769b1f() {
      this.I_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("adaptive_state/data"), VertexFormats.POSITION_TEXTURE_COLOR);
   }

   public void I_method_25e00c41(float var1, float var2, float var3) {
      if (this.I_field_2f5b1d2c != null && !VelumClient.getInstance().i_method_e8604970()) {
