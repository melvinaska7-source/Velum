...
import velum.client.IiiiiiII_Class125;
import velum.client.IiiiiiIi_Class126;
...
import velum.client.iIIIIIii_Class132;
import velum.client.iIIIIiII_Class133;
import velum.client.iIIIIiIi_Class134;
import velum.client.iIIIIiiI_Class135;
...
public class IiiiiiiI_Class127 {
    ...
    public static boolean I_method_731950d0() {
        EspModule iIiIIiIiI_Class75 = VelumClient.getInstance().getModuleManager().getModule(EspModule.class);
    ...
    public void i_method_4779630d(IiiiIiiI_Class119 iiiiIiiI_Class119) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.warn("Config: \u043d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u0441\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u044d\u043b\u0435\u043c\u0435\u043d\u0442 ESP {}", (Object)iiiiIiiI_Class119.I_method_4b007174(), (Object)exception);
        }
        VelumClient.getInstance().I_method_7897deab().i_method_f30f2128(iiiiIiiI_Class119);
    }
