...
import pyvelum.events.client.NotificationEvent;
...
import velum.client.iiIiiiI_Class111;
import velum.client.iiiIIII_Class113;
import velum.client.iiiIIIi_Class114;
import velum.client.iiiIIiI_Class115;
import velum.client.iiiIIii_Class116;
import velum.client.iiiIiiI_Class119;
...
public class iiIiiii_Class112 {
    ...
    private void i_method_9182d767(iiIiiiI_Class111 iiIiiiI_Class1112) {
        ...
        try {
            VelumClient.getInstance().I_method_7897deab().I_method_e7f802ad(new NotificationEvent(string, string2, string3 == null ? "" : string3, string4 == null ? "" : string4));
        }
