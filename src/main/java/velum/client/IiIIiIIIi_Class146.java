...
import velum.client.IIiIIiII_Class37;
import velum.client.IiIII_Class9;
import velum.client.IiIIIiII_Class69;
import velum.client.IiIIiIIiI_Class147;
...
implements iIIiIIiIi_Class294 {
    ...
    private void I_method_d4725201(float f, float f2, String string, Vec3d vec3d) {
        ...
        this.I_field_ab760aac.I_method_78c7e89(IiIiIIII_Class81.I_method_f25a980a("remove"), "trash", iiIIiiIii_Class156 -> {
            VelumClient.getInstance().I_method_cf3ba442().I_method_d7f5649(string);
            iiIIiiIii_Class156.I_method_c3d80455(false);
        });
    }
    ...
    private Map.Entry<String, Vec3d> I_method_15b7de66(double d, double d2) {
        ...
        for (Map.Entry<String, Vec3d> entry : VelumClient.getInstance().I_method_cf3ba442().I_method_173f1fee()) {
            float f;
            float f2;
            float f3;
