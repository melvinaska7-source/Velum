...
import velum.client.iIiIiiiiI_Class351;
import velum.client.iiIiIIIIi_Class418;
import velum.client.iiIiIIIii_Class420;
import velum.client.iiIiIIiIi_Class422;

public class iiIiIIiII_Class421 {
    static final Logger I_field_ab0f6068 = LoggerFactory.getLogger((String)"velum-lyrics");
    ...
    private static final String II_field_523beb0a = "Velum/2.0 (https://github.com/velum)";
