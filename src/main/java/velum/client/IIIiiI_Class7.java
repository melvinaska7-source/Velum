...
import velum.client.IIIiii_Class8;
import velum.client.VelumClient;
import velum.client.IiiIi_Class14;
...
iIIiIIiii_Class296 {
    ...
    public void I_method_800d826c() {
        ...
        this.I_field_83b91601 = new IIIiii_Class8(VelumClient.id("volumetric_fog/data"));
        this.I_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("volumetric_fog/tent/data"), VertexFormats.POSITION_TEXTURE_COLOR);
    }
