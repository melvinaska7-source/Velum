...
import velum.client.IiiIIiIi_Class102;
import velum.client.IiiIiIii_Class108;
import velum.client.IiiIiiII_Class109;
import velum.client.IiiIiiIi_Class110;
...
iIIiIIiiI_Class295 {
    ...
    public void close() {
        ...
        super.close();
        I_field_3a9bda27.setScreen((Screen)VelumClient.getInstance().I_method_96982062());
    }
