...
import velum.client.IiiiiiIII_Class249;
...
extends Module {
    ...
    public void II_method_6642fd22() {
        ...
        Entity entity = VelumClient.getInstance().I_method_9a638462().I_method_9c10f815();
    ...
    private void iIi_method_69360e5f() {
        ...
        if (nested1_95187080 != null && itemStack.getItem() != Items.AIR) {
            ...
            VelumClient.getInstance().I_method_5cb1af22().I_method_67864747(new iiiIiIi_Class118(IiIiIIII_Class81.I_method_1410d1e5("alerts.moved_to_offhand", string), itemStack).I_method_7ab92a7f(string).I_method_c9efc756(nested1_95187080.I_method_40d7118b(itemStack)));
        }
    }
    ...
    private void I_method_df416067(iIIiiIiII_Class309<iIIiIiIii_Class300> iIIiiIiII_Class3092) {
        ...
        if (nested1_95187080 != null) {
            ...
            VelumClient.getInstance().I_method_5cb1af22().I_method_67864747(new iiiIiIi_Class118(IiIiIIII_Class81.I_method_1410d1e5("alerts.moved_to_offhand", string), targetHead).I_method_7ab92a7f(string).I_method_c9efc756(nested1_95187080.I_method_40d7118b(targetHead)));
        }
    }
    ...
    private boolean iiI_method_6aea72a3() {
        return !VelumClient.getInstance().getModuleManager().getModule(AutoTotemModule.class).Iii_method_6f0929f0();
    }
