...
import velum.client.iiIIIiiii_Class400;
import velum.client.iiIIiIIII_Class401;
...
extends IiiiIiiI_Class119 {
    ...
    private final IiIIIiII_Class69<Render3DEvent> i_field_3d936f41 = render3DEvent -> {
        ...
        VertexConsumer vertexConsumer = immediate.getBuffer(RenderLayer.getEntityTranslucent((Identifier)VelumClient.id("textures/entity/taksa.png")));
        matrixStack.push();
