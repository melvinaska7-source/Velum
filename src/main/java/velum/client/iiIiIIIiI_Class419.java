...
public class iiIiIIIiI_Class419 implements iIIiIIiIi_Class294 {
   private static final Logger I_field_ab0f6068 = LoggerFactory.getLogger("velum-lyrics");
   ...
   private static final Executor I_field_54ff24dc = I_method_49211fcf("velum-track-lyrics");
   private static final Executor i_field_54ff24dc = I_method_49211fcf("velum-track-metadata");
   ...
   private void I_method_67ab8991(NativeImage var1, ColorRGBA var2) {
      Identifier var3 = var1 == null ? null : VelumClient.id("temp/artwork_" + I_field_bc9b37c0.incrementAndGet());
