...
import velum.client.IiIIIiIiI_Class139;
...
import velum.client.iIIIIIiii_Class264;
...
extends Module {
    ...
    private boolean i_method_10982c75(LivingEntity livingEntity) {
        float f = VelumClient.getInstance().getModuleManager().getModule(AuraModule.class).I_method_921cfc81(livingEntity);
    ...
    public boolean IiI_method_80b6a210() {
        ...
        object = VelumClient.getInstance().getModuleManager().getModule(CriticalsModule.class);
