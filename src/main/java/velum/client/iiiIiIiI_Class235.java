...
import velum.client.iiiIIiii_Class232;
...
public final class iiiIiIiI_Class235 {
    ...
    private final IiIIIiII_Class69<ClientPlayerTickEvent> i_field_3d936f41 = clientPlayerTickEvent -> {
        ...
        ++this.III_field_49;
        boolean bl = VelumClient.getInstance().I_method_58785402().I_method_3d166e03();
    ...
    public String I_method_50bc076a(String string) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[Neuro] \u043d\u0435 \u043e\u0442\u043a\u0440\u044b\u0442\u044c \u0434\u0430\u0442\u0430\u0441\u0435\u0442", (Throwable)exception);
    ...
    private static void I_method_1db64cb(Path path) {
        try (FileChannel fileChannel = FileChannel.open(path, StandardOpenOption.READ, StandardOpenOption.WRITE);){
            ...
            VelumClient.I_field_ab0f6068.warn("[Neuro] \u043d\u0435 \u043f\u043e\u0434\u0440\u0435\u0437\u0430\u0442\u044c \u0445\u0432\u043e\u0441\u0442 \u0434\u0430\u0442\u0430\u0441\u0435\u0442\u0430: {}", (Object)exception.getMessage());
        }
    }
    ...
    private void I_method_884e7c75(boolean bl, float f, float f2, float f3, float f4, LivingEntity livingEntity) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[Neuro] \u043d\u0435 \u0437\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u0442\u0438\u043a \u0431\u043e\u044f", (Throwable)exception);
            this.I_method_be26612c();
        }
    }
