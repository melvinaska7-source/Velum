...
public final class IIiiIiiI_Class55 {
   ...
   public IIIiiIIi_Class26 I_method_2ff75bab() {
      List var1 = VelumClient.getInstance().I_method_a90eb842().i_method_619cb248().stream().map(IIiiIIiii_Class104::I_method_332d5061).toList();
   ...
   static enum Nested1_81372cd3 {
         ...
         return switch (this) {
            ...
            case Iii_field_23bc9dfc -> var0 -> {
               try {
                  ...
                  VelumClient.I_field_ab0f6068.error(IiIiIIII_Class81.I_method_1410d1e5("commands.lua.dir.error", var3.getMessage()));
               }
            };
         };
      }
      ...
      private void I_method_291ce2c7() {
         IIiiIIiiI_Class103 var1 = VelumClient.getInstance().I_method_a90eb842();
                     ...
                     try {
                        ...
                        try (BufferedReader var5 = new BufferedReader(new InputStreamReader(var4.getInputStream(), StandardCharsets.UTF_8))) {
                           while ((var6 = var5.readLine()) != null) {
                              VelumClient.I_field_ab0f6068.info("[pip] {}", var6);
