...
import velum.client.iIiiI_Class23;
import velum.client.iiIIi_Class26;
...
implements iIIiIIiii_Class296 {
    ...
    private void i_method_8e9b93f7(int n) {
        ...
        iiIIi_Class26 iiIVelumClient62 = nested1_42765c60 == this.Ii_field_500d0627 ? iIiiIIiii_Class360.i_field_65e7a52c : (nested1_42765c60 == this.iI_field_500d0627 ? iIiiIIiii_Class360.II_field_65e7a52c : iIiiIIiii_Class360.I_field_65e7a52c);
        if (iiIVelumClient62 == null) {
            return;
        }
        ...
        ColorRGBA colorRGBA = this.I_method_72aa1b1b();
        iiIVelumClient62.I_method_33f6c16b();
        iiIVelumClient62.I_method_86be3e5e(f3, colorRGBA, this.I_field_b4b[n], this.i_field_b4b[n]);
