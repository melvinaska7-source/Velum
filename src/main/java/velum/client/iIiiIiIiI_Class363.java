...
import moscow.velum.mixin.accessors.MultiPhaseParametersAccessor;
import moscow.velum.mixin.accessors.RenderLayerMultiPhaseAccessor;
import moscow.velum.mixin.accessors.RenderPhaseAccessor;
import moscow.velum.mixin.accessors.RenderPhaseTextureAccessor;
   ...
   private static RenderLayer I_method_6bd16b0f(RenderLayer var0) {
      ...
      if (var1 != null) {
         ...
         if (var0 instanceof RenderLayerMultiPhaseAccessor var3) {
            MultiPhaseParametersAccessor var4 = (MultiPhaseParametersAccessor)(Object)var3.velum$getPhases();
            if (var4.velum$getTransparency() == RenderPhaseAccessor.velum$getNoTransparency()
               && var4.velum$getTexture() instanceof RenderPhaseTextureAccessor var5) {
               Identifier var7 = var5.velum$getId().orElse(null);
               if (var7 != null) {
