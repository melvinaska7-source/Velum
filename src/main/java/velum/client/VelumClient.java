...
public enum VelumClient implements iIIiIIiIi_Class294 {
   I_field_502d1741;

   public static final String I_field_523beb0a = "Velum";
   public static final String i_field_523beb0a = "2.1";
   public static final String II_field_523beb0a = "Velum".toLowerCase();
   public static final String Ii_field_523beb0a = "https://ftapi.velum.pub/v1/";
   public static final String iI_field_523beb0a = "velum.pub";
   ...
   public void initialize() {
      I_field_ab0f6068.info("Initializing {}...", "Velum");
      ...
      try {
         FunTimeEventsAPI.builder().userAgent("Velum").baseUrl("https://ftapi.velum.pub/v1/").build();
      ...
      ResourceManagerHelper.get(ResourceType.CLIENT_RESOURCES).registerReloadListener(new SimpleSynchronousResourceReloadListener() {
         public Identifier getFabricId() {
            return VelumClient.id("after_shader_load");
         }

         public void reload(ResourceManager var1) {
            if (!VelumClient.this.II_field_5a) {
      ...
      I_field_ab0f6068.info("{} initialized", "Velum");
   }
   ...
   public static VelumClient getInstance() {
