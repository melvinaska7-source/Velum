...
import velum.client.Iiiii_Class16;

public class iIiIiiiii_Class352 {
    private static final long I_field_4a = 1592635409L;
    private final Iiiii_Class16 I_field_2f5b954c = new Iiiii_Class16(VelumClient.id("ambient_particles/data"));
    ...
    private RenderLayer I_method_50d02d69(boolean bl, Identifier identifier) {
        ...
        if (bl) {
            if (this.i_field_2aba9115 == null) {
                this.i_field_2aba9115 = this.I_method_85fc7d86("velum_ambient_particles_additive", RenderPhase.ADDITIVE_TRANSPARENCY, identifier);
            }
            return this.i_field_2aba9115;
        }
        if (this.I_field_2aba9115 == null) {
            this.I_field_2aba9115 = this.I_method_85fc7d86("velum_ambient_particles", RenderPhase.TRANSLUCENT_TRANSPARENCY, identifier);
        }
        return this.I_field_2aba9115;
    }
