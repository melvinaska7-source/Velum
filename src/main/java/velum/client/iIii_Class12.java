...
import velum.client.IiIIIiIii_Class140;
import velum.client.IiIIiIiII_Class149;
import velum.client.IiIIi_Class10;
import velum.client.IiIiIIII_Class81;
import velum.client.IiIii_Class12;
import velum.client.VelumClient;
import velum.client.IiiiIiIii_Class236;
import velum.client.IiiiIiiII_Class237;
import velum.client.IiiiIiiIi_Class238;
...
import velum.client.iIIiIIiii_Class296;
...
iIIiIIiii_Class296 {
    ...
    protected void drawSelf(III iII, float f) {
        ...
        float f4 = this.w();
        float f5 = this.h();
        boolean bl = VelumClient.getInstance().I_method_9a720c62().I_method_ac8a0395() == IiIIIiIii_Class140.I_field_74daf6cc;
        ...
        iII.drawRoundedTexture(VelumClient.id("textures/hue.png"), f2 + f4 - 18.0f, f3 + 20.0f, 12.0f, 70.0f, IIiii_Class8.I_method_893b2757(4.0f));
        ...
        if (this.I_field_5a) {
            ...
            iII.drawRoundedTexture(VelumClient.id("textures/empty.png"), f2 + 6.0f, f3 + 102.0f, 100.0f, 12.0f, IIiii_Class8.I_method_893b2757(5.0f));
