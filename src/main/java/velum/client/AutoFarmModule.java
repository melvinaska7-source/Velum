...
import velum.client.IIIiiIiii_Class56;
import velum.client.IIIiiiIII_Class57;
import velum.client.IIIiiiIiI_Class59;
import velum.client.IIIiiiIii_Class60;
import velum.client.IIIiiiiII_Class61;
import velum.client.IIIiiiiIi_Class62;
import velum.client.IIIiiiiiI_Class63;
import velum.client.IIIiiiiii_Class64;
import velum.client.IIiIIIIII_Class65;
import velum.client.IIiIIIIiI_Class67;
...
extends Module {
    ...
    public void onEnable() {
        ...
        VelumClient.getInstance().I_method_7897deab().I_method_2257cd48(this.I_field_e6afbe8c);
        if (this.I_field_bfaf92ac != null) {
            VelumClient.getInstance().I_method_7897deab().I_method_2257cd48(this.I_field_bfaf92ac);
    ...
    public void onDisable() {
        ...
        VelumClient.getInstance().I_method_7897deab().i_method_f30f2128(this.I_field_e6afbe8c);
        if (this.I_field_bfaf92ac != null) {
            this.I_field_bfaf92ac.i_method_a103c9ff();
            VelumClient.getInstance().I_method_7897deab().i_method_f30f2128(this.I_field_bfaf92ac);
