...
extends Module {
    ...
    public void II_method_6642fd22() {
        if (!VelumClient.getInstance().getModuleManager().getModule(AuraModule.class).isEnabled()) {
    ...
    private void I_method_dc50cc51(LivingEntity livingEntity) {
        ...
        if (VelumClient.getInstance().getModuleManager().getModule(ElytraStrafeModule.class).isEnabled()) {
            return;
        }
