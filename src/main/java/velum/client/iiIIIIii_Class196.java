...
public class iiIIIIii_Class196 extends iI_Class3 {
   ...
   private iiIIIIiI_Class195 I_method_9abdcfeb() {
      return this.I_field_39e1ab71 == iiIIIIii_Class196.Nested1_1032e5d6.i_field_39e1ab71
         ? VelumClient.getInstance().I_method_11732eb().i_method_beb2642b()
         : VelumClient.getInstance().I_method_11732eb().I_method_94b5d40b();
   }
   ...
   private float[] II_method_5f112f6c() {
      if (this.I_field_39e1ab71 == iiIIIIii_Class196.Nested1_1032e5d6.II_field_39e1ab71) {
         iiIIIiIi_Class198 var5 = VelumClient.getInstance().I_method_11732eb().I_method_417b4cc3(this.iI_method_25dc4425());
         return new float[]{
   ...
   private float iI_method_25dc4425() {
      float var1 = VelumClient.getInstance().I_method_11732eb().I_method_78c80362().Ii_method_a20abcd2();
   ...
   private float[] Ii_method_60d41f8c() {
      iiIIIIIi_Class194 var1 = VelumClient.getInstance().I_method_11732eb();
   ...
   private void I_method_5d57bd97(float[] var1) {
      iiIIIIIi_Class194 var2 = VelumClient.getInstance().I_method_11732eb();
