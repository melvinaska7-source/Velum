...
import pyvelum.events.client.ModuleToggledEvent;
...
import velum.client.IiIIiiii_Class80;
import velum.client.IiIiIIII_Class81;
import velum.client.ModuleEntry;
import velum.client.IiIiiiII_Class93;
...
import velum.client.iIIIIiIiI_Class267;
...
implements ModuleEntry {
    ...
    public final void setEnabled(boolean bl, boolean bl2) {
        ...
        this.I_field_5a = bl;
        VelumClient.getInstance().I_method_7897deab().I_method_e7f802ad(new ModuleToggledEvent(new PyModule(this), this.I_field_5a));
        if (!(this instanceof MenuModule) && !(this instanceof GlobalsMenuModule) && VelumClient.getInstance().getModuleManager().getModule(SoundsModule.class).isEnabled() && !bl2) {
            iiIiIIIII_Class417.i_field_34b2ba6c.I_method_7289b65f(VelumClient.getInstance().getModuleManager().getModule(SoundsModule.class).I_method_45ee5ef(), this.I_field_5a ? 1.1f : 1.0f);
        }
        if (this.I_field_5a) {
            ...
            if (!(bl2 || this instanceof MenuModule || this instanceof GlobalsMenuModule)) {
                VelumClient.getInstance().I_method_5cb1af22().I_method_8ee48d11(iiiIIII_Class113.I_field_c11fcfcc, this.I_field_523beb0a.replace(" ", "") + " " + IiIiIIII_Class81.I_method_f25a980a("enabled") + (IiIiIIII_Class81.I_method_21a4cfeb() == IiIIiiii_Class80.i_field_3f56db61 ? iIIIIiIiI_Class267.I_method_c7255d57(this.I_field_523beb0a) : ""));
            }
            this.onEnable();
        } else {
