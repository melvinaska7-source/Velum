...
import pyvelum.utility.render.Rect;
...
public final class iIiiIIiii_Class360 implements iIIiIIiIi_Class294, iIIiIIiii_Class296 {
   ...
   public static void i_method_49c385df() {
      I_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("rectangle/data"), VertexFormats.POSITION_COLOR);
      ii_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("squircle/data"), VertexFormats.POSITION_COLOR);
      IIi_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("squircle_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      IiI_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("proj_squircle/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      III_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      Iii_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("border/data"), VertexFormats.POSITION_COLOR);
      iII_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("dashed_border/data"), VertexFormats.POSITION_COLOR);
      iIi_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("bezier/data"), VertexFormats.POSITION_COLOR);
      iiI_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("squircle_border/data"), VertexFormats.POSITION_COLOR);
      iii_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("loading/data"), VertexFormats.POSITION_COLOR);
      IIII_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("liquidglass/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      IIIi_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("gradient_rectangle/data"), VertexFormats.POSITION_COLOR);
      IIiI_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("metaball/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      IIii_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("islandblob/data"), VertexFormats.POSITION_COLOR);
      i_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("mapped_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      II_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("ui_universal/data"), VertexFormats.POSITION_TEXTURE_COLOR_LIGHT);
      Ii_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("adaptive_ui/data"), VertexFormats.POSITION_TEXTURE_COLOR_LIGHT);
      I_field_2f5b916c = new IiiiI_Class15();
      I_field_2f5b916c.I_method_6769b1f();
      IiIi_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("backdrop_blur/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      iI_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("ui_stream/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      IiII_field_2f5b1d2c = new IiiIi_Class14(VelumClient.id("arc/data"), VertexFormats.POSITION_COLOR);
      ...
      I_field_643340ec = new iIiIi_Class22(VelumClient.id("glow/entity_solid/data"));
      GlowRenderLayers.initShader(I_field_643340ec);
      I_field_83aa8641 = new IIIIiI_Class3(VelumClient.id("sky_nebula/data"));
      iIiiiIiIi_Class374.I_method_aaaff9c0(I_field_83aa8641);
      i_field_83aa8641 = new IIIIiI_Class3(VelumClient.id("sky_sunset/data"));
      iIiiiIiIi_Class374.I_method_aaaff9c0(i_field_83aa8641);
      II_field_83aa8641 = new IIIIiI_Class3(VelumClient.id("sky_radiant/data"));
      iIiiiIiIi_Class374.I_method_aaaff9c0(II_field_83aa8641);
      Ii_field_83aa8641 = new IIIIiI_Class3(VelumClient.id("sky_caustic/data"));
      iIiiiIiIi_Class374.I_method_aaaff9c0(Ii_field_83aa8641);
      I_field_64252d2c = new iIIii_Class20(VelumClient.id("sky_galaxy/bake/data"), VelumClient.id("sky_galaxy/view/data"));
      iIiiiIiIi_Class374.I_method_55fe86c7(I_field_64252d2c);
      i_field_64252d2c = new iIIii_Class20(VelumClient.id("sky_space/bake/data"), VelumClient.id("sky_space/view/data"));
      iIiiiIiIi_Class374.I_method_55fe86c7(i_field_64252d2c);
      I_field_83aa1201 = new IIIIIi_Class2(VelumClient.id("saturation/data"));
      I_field_856cfe41 = new IIiIII_Class9(VelumClient.id("wet_world/data"));
      I_field_65f6310c = new iiiIi_Class30(VelumClient.id("mirror_composite/data"));
      I_field_65e7a52c = new iiIIi_Class26(VelumClient.id("item_caustic/data"));
      i_field_65e7a52c = new iiIIi_Class26(VelumClient.id("item_plasma/data"));
      II_field_65e7a52c = new iiIIi_Class26(VelumClient.id("item_lava/data"));
      SmoothItemLayers.initShaders(
         new IiiIi_Class14(VelumClient.id("item_smooth/translucent/data"), VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL),
         new IiiIi_Class14(VelumClient.id("item_smooth/cutout/data"), VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL)
      );
      BlockGhostLayers.initShader(new IiiIi_Class14(VelumClient.id("block_ghost/data"), VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL));
   }
   ...
   public static void I_method_53b46eca(MatrixStack var0, iiIIIiIII_Class393 var1, float var2, float var3, float var4, float var5, ColorRGBA var6) {
      I_method_30d83731(
         var0,
         VelumClient.id(var1.I_method_757dbb95().I_method_10abec01()),
         var2,
         var3,
         var4,
         var5,
   ...
   public static void I_method_bc6b2f81(MatrixStack var0, Rect var1, float var2, float var3, float var4, float var5, IIiii_Class8 var6, float var7) {
      if (!I_method_b06b6e43(var4, var5) && !(var7 <= 0.0F)) {
         ...
         I_field_6425294c.i_method_54fa74c1(2.0F);
         III_field_2f5b1d2c.I_method_33f6c16b();
         RenderSystem.setShaderTexture(0, VelumClient.id("rocknet/blur.png"));
         III_field_2f5b1d2c.I_method_cb7dbe45("Size").set(var4, var5);
         III_field_2f5b1d2c.I_method_cb7dbe45("Radius")
            .set(var6.I_method_b483cecf(), var6.Ii_method_dc139032(), var6.i_method_b4925aaf(), var6.II_method_dc050452());
