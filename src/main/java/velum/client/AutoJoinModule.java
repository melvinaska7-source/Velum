...
import velum.client.iIIIIIiIi_Class262;
...
extends Module {
    ...
    private final IiIIIiII_Class69<ReceivePacketEvent> i_field_3d936f41 = receivePacketEvent -> {
        ...
        if (this.I_method_97ab422d((String)object)) {
            ...
            if (!this.II_field_5a) {
                ...
                VelumClient.getInstance().I_method_5cb1af22().I_method_20d0f49b(iiiIIII_Class113.II_field_c11fcfcc, IiIiIIII_Class81.I_method_f25a980a("auto_join.retry"), IiIiIIII_Class81.I_method_f25a980a("auto_join.retry.desc"));
            }
            return;
        }
    ...
    private void iII_method_aa82b65f() {
        VelumClient.getInstance().I_method_5cb1af22().I_method_20d0f49b(iiiIIII_Class113.I_field_c11fcfcc, IiIiIIII_Class81.I_method_f25a980a("auto_join.success"), IiIiIIII_Class81.I_method_f25a980a("auto_join.success.desc"));
        this.disable();
    }
