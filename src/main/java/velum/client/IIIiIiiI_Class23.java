...
import velum.client.IIIiIiII_Class21;
...
public final class IIIiIiiI_Class23 {
    ...
    public boolean II_method_a05c2039() {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[CaptureShield] \u043d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u0441\u043e\u0437\u0434\u0430\u0442\u044c \u043e\u043a\u043d\u043e \u043f\u0440\u0438\u0432\u0430\u0442\u043d\u043e\u0433\u043e \u0441\u043b\u043e\u044f", throwable);
            try {
                GLFW.glfwMakeContextCurrent((long)l);
    ...
    public void I_method_b8ccbf5e(int n, int[] nArray, int n2, int n3, int n4) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[CaptureShield] \u043e\u0448\u0438\u0431\u043a\u0430 \u0432\u044b\u0432\u043e\u0434\u0430 \u043f\u0440\u0438\u0432\u0430\u0442\u043d\u043e\u0433\u043e \u0441\u043b\u043e\u044f", throwable);
            this.i_field_5a = true;
        }
        finally {
            GLFW.glfwMakeContextCurrent((long)l);
