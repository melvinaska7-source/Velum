...
import moscow.velum.mixin.accessors.DrawContextAccessor;
...
import velum.client.IIiiiIIIi_Class114;
import velum.client.IIiii_Class8;
import velum.client.IiIII_Class9;
import velum.client.IiIIIiII_Class69;
import velum.client.IiIIiIIIi_Class146;
import velum.client.IiIIiIiiI_Class151;
import velum.client.IiIIiiIii_Class156;
import velum.client.IiIiIIII_Class81;
import velum.client.IiIiIIIIi_Class162;
import velum.client.IiIiIIiII_Class165;
import velum.client.IiIiIIiIi_Class166;
import velum.client.IiIiIIiiI_Class167;
import velum.client.IiIiIIiii_Class168;
import velum.client.IiIiIiIIi_Class170;
import velum.client.IiIiIiIiI_Class171;
import velum.client.IiIiIiIii_Class172;
import velum.client.IiIiIiiII_Class173;
import velum.client.IiIiIiiIi_Class174;
import velum.client.IiIiIiiiI_Class175;
import velum.client.IiIiIiiii_Class176;
import velum.client.IiIiiIIII_Class177;
import velum.client.VelumClient;
import velum.client.IiiIIIiii_Class200;
import velum.client.IiiIIiIII_Class201;
import velum.client.IiiIIiIIi_Class202;
import velum.client.IiiiIiiII_Class237;
import velum.client.IiiiiiiI_Class127;
import velum.client.iIIIIiII_Class133;
import velum.client.iIIIiIIIi_Class274;
import velum.client.iIIIiIIiI_Class275;
import velum.client.iIIiIIIiI_Class291;
import velum.client.iIIiIIiIi_Class294;
import velum.client.iIIiIIiiI_Class295;
import velum.client.iIiiiIIiI_Class371;
import velum.client.iIiiiiIii_Class380;
import velum.client.iiIiIIiii_Class424;
import velum.client.iiiIIII_Class113;
...
iIIiIIiiI_Class295 {
    ...
    private final IiIIIiII_Class69<HudRenderEvent> I_field_3d936f41 = hudRenderEvent -> {
        ...
        try (iIiiiiIii_Class380 iIiiiiIii_Class3802 = iIiiiiIii_Class380.i_method_9a230ed5();){
            for (IiIiIIiII_Class165 iIIiIIiVelumClient942 : this.iI_field_7865b31) {
                iIIiIIiVelumClient942.render(iII);
                if (!(iIIiIIiVelumClient942.getSelecting().I_method_6ac4da6f() >= 0.0f)) continue;
                float f = iIIiIIiVelumClient942.getAnimation().I_method_6ac4da6f() * iIIiIIiVelumClient942.getVisible().I_method_6ac4da6f();
                float f2 = 0.5f + f * 0.5f - 0.05f * iIIiIIiVelumClient942.getSelecting().I_method_6ac4da6f();
                iIIiIIiVelumClient942.getLoadingAnim().I_method_edd6ec25(1500L);
                iIIiIIiVelumClient942.getLoadingAnim().I_method_edd6dd11(1.0f);
                if (iIIiIIiVelumClient942.getLoadingAnim().I_method_6ac4da6f() == 1.0f) {
                    iIIiIIiVelumClient942.getLoadingAnim().I_method_edd6dd21(0.0f);
                }
                iIiiiIIiI_Class371.II_method_e18635ac(iII.getMatrices(), iIIiIIiVelumClient942.getX() + iIIiIIiVelumClient942.getWidth() / 2.0f, iIIiIIiVelumClient942.getY() + iIIiIIiVelumClient942.getHeight() / 2.0f, f2);
                iII.drawLoadingRect(iIIiIIiVelumClient942.getX(), iIIiIIiVelumClient942.getY(), iIIiIIiVelumClient942.getWidth(), iIIiIIiVelumClient942 instanceof IiIiIIiii_Class168 ? Math.max(20.0f, iIIiIIiVelumClient942.getHeight()) : iIIiIIiVelumClient942.getHeight(), iIIiIIiVelumClient942.getLoadingAnim().I_method_6ac4da6f() * 2.2f - 0.5f, IIiii_Class8.I_method_893b2757(7.0f), ColorRGBA.WHITE.withAlpha(100.0f * iIIiIIiVelumClient942.getSelecting().I_method_6ac4da6f()));
        ...
        if (chatClickEvent.getButton() == 1 && !this.i_method_9e870e08().isEmpty()) {
            ...
            for (IiIiIIiII_Class165 iiIiIIiII_Class165 : this.i_method_9e870e08()) {
                iiIIiiIii_Class1562.I_method_78c7e89(IiIiIIII_Class81.I_method_f25a980a(iiIiIIiII_Class165.getName()), iiIiIIiII_Class165.getIcon(), iiIIiiIii_Class156 -> {
                    ...
                    VelumClient.getInstance().I_method_7a4c3f0b().i_method_af563376("client");
                });
            }
            ...
            VelumClient.getInstance().I_method_5cb1af22().I_method_20d0f49b(iiiIIII_Class113.i_field_c11fcfcc, IiIiIIII_Class81.I_method_f25a980a("hud.no_elements"), IiIiIIII_Class81.I_method_f25a980a("hud.no_elements.desc"));
            this.I_field_991c1e8c.I_method_23e11e3f();
        }
    };
    private final IiIIIiII_Class69<ChatReleaseEvent> iI_field_3d936f41 = chatReleaseEvent -> {
        for (IiIIiiIii_Class156 iIIiIIiVelumClient942 : this.ii_field_7865b31) {
            iIIiIIiVelumClient942.i_method_6a097ac7(chatReleaseEvent.getX(), chatReleaseEvent.getY(), IiIII_Class9.I_method_40dce65a(chatReleaseEvent.getButton()));
            if (!iIIiIIiVelumClient942.I_method_a74dc6d0(chatReleaseEvent.getX(), chatReleaseEvent.getY())) continue;
            return;
        }
        for (IiIiIIiII_Class165 iiIiIIiII_Class165 : this.iI_field_7865b31) {
    ...
    public boolean I_method_f4b70b23(int n, int n2) {
        ...
        ViewModelModule iIiIiiIIi_Class90 = VelumClient.getInstance().getModuleManager().getModule(ViewModelModule.class);
    ...
    private boolean I_method_f4b5a2c3(float f, float f2) {
        ...
        IiIIiIIIi_Class146 iiIIiIIIi_Class146 = VelumClient.getInstance().I_method_cf3ba822();
