...
public abstract class IiIiIIiII_Class165 implements IIiiiIIiI_Class115, iIIiIIiIi_Class294 {
   ...
   private void pushNeighbours(float var1, boolean var2) {
      for (IiIiIIiII_Class165 var5 : VelumClient.getInstance().I_method_35687482().III_method_812fc188()) {
   ...
   public void onMouseClicked(double var1, double var3, IiIII_Class9 var5) {
      if (this.isHovered(var1, var3) && this.showing) {
         if (var5 == IiIII_Class9.I_field_2f4c8d6c) {
            ...
            VelumClient.getInstance().I_method_35687482().IIi_method_367bf9a8().add(var6);
         }
      }
   }
   ...
   public void onMouseReleased(double var1, double var3, IiIII_Class9 var5) {
      if (this.dragging && var5 == IiIII_Class9.I_field_2f4c8d6c) {
         ...
         if (this.x != this.startDragX || this.y != this.startDragY) {
            VelumClient.getInstance().I_method_35687482().I_method_fe8673b5().I_method_1bfadd07(this, this.startDragX, this.startDragY, this.x, this.y);
         }
   ...
   private float snapDelta(IiIiIIIiI_Class163.Nested1_6dffbfe0 var1, float var2, float var3) {
      ...
      for (IiIiIIIiI_Class163 var8 : VelumClient.getInstance().I_method_35687482().I_method_fe777395().I_method_18838208()) {
      ...
      if (var5 > 2.0F) {
         ...
         for (IiIiIIIiI_Class163 var16 : VelumClient.getInstance().I_method_35687482().I_method_fe777395().I_method_18838208()) {
   ...
   public void setShowing(boolean var1) {
      ...
      if (var2 != var1) {
         IiIiIIIii_Class164 var3 = VelumClient.getInstance().I_method_35687482();
         if (var3 != null) {
