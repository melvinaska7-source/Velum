...
import velum.client.iIIiiiiIi_Class318;
...
extends Module {
    ...
    private final IiIIIiII_Class69<ClientPlayerTickEvent> i_field_3d936f41 = clientPlayerTickEvent -> {
        ...
        if (this.I_field_500d0627.isSelected()) {
            ...
            if (SpiderModule.I_field_3a9bda27.player.horizontalCollision) {
                VelumClient.getInstance().I_method_58785402().I_method_1acbf705(new iiIIiIIii_Class404((double)SpiderModule.I_field_3a9bda27.player.getYaw(), 78.5), iiIIiIIIi_Class402.i_field_32e0c64c, 180.0f, 180.0f, 180.0f, iiIIiIiiI_Class407.iI_field_32efc66c);
