...
import velum.client.iIiII_Class21;
...
iIIiIIiii_Class296 {
    ...
    public void I_method_716dedf() {
        if (I_field_64333d0c == null) {
            I_field_64333d0c = new iIiII_Class21(VelumClient.id("glow/blur_h/data"));
            i_field_64333d0c = new iIiII_Class21(VelumClient.id("glow/blur_v/data"));
            II_field_64333d0c = new iIiII_Class21(VelumClient.id("glow/composite/data"));
        }
    }
