...
import velum.client.IiIIiIii_Class76;
...
public class IiIIiIII_Class73 {
    ...
    public static final File I_field_3a58077 = new File(MinecraftClient.getInstance().runDirectory, "Velum");
    ...
    public void i_method_af563376(String string) {
        IiIIIiii_Class72 iiIIIiii_Class72 = this.I_method_3272b401(string);
        if (iiIIIiii_Class72 != null) {
            if (iiIIIiii_Class72 instanceof IiIIiIiI_Class75 && VelumClient.getInstance().I_method_789852eb() != null) {
                VelumClient.getInstance().I_method_789852eb().II_method_d4269835();
            }
