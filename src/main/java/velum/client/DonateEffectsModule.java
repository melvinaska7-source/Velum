...
import moscow.velum.mixin.accessors.AbstractSoundInstanceAccessor;
...
import pyvelum.events.game.SoundEvent;
...
public class DonateEffectsModule extends Module {
   ...
   private static final Map<String, Identifier> II_field_a567c40b = Map.of(
      "potion-radiation",
      VelumClient.id("icons/potions/radio.png"),
      "potion-paladin",
      VelumClient.id("icons/potions/shield.png"),
      "potion-assassin",
      VelumClient.id("icons/potions/sword.png"),
      "potion-holy-water",
      VelumClient.id("icons/potions/holy.png"),
      "potion-popper",
      VelumClient.id("icons/potions/bomb.png"),
      "potion-drowsiness",
      VelumClient.id("icons/potions/moon.png"),
      "potion-rage",
      VelumClient.id("icons/potions/angry.png")
   );
      ...
      if (this.I_field_ba20ca4c.i_method_9b12da03() || this.i_field_ba20ca4c.i_method_9b12da03()) {
         if (iIIIiiiII_Class285.Ii_method_b349c526()) {
            ...
            if (var2 != null) {
               ...
               float var4 = ((AbstractSoundInstanceAccessor)(Object)var2).velum$getVolume();
         ...
         while (var23.hasNext()) {
            ...
            if (!var1.contains(var25)) {
               ...
               if (var28 == null) {
                  ...
                  Identifier var8 = II_field_a567c40b.getOrDefault(var28, VelumClient.id("icons/add.png"));
