...
import pyvelum.events.client.LanguageChangedEvent;
import velum.client.IiIIiiiI_Class79;
import velum.client.IiIIiiii_Class80;
import velum.client.IiIiIIIi_Class82;
...
public final class IiIiIIII_Class81 {
    ...
    public static void I_method_b508148c() {
        String string = "/assets/" + VelumClient.II_field_523beb0a + "/lang/" + i_field_3f56db61.I_method_881af974() + ".lang";
        try {
            String string2;
    ...
    public static void I_method_9b03faed(@Nonnull IiIIiiii_Class80 iiIIiiii_Class80) {
        ...
        if (VelumClient.getInstance() != null && VelumClient.getInstance().I_method_7897deab() != null) {
            VelumClient.getInstance().I_method_7897deab().I_method_e7f802ad(new LanguageChangedEvent(iiIIiiii_Class80.I_method_881af974()));
        }
    }
    ...
    private static void I_method_593372f7(String string, int n, String string2) {
        ...
        if (n2 == -1) {
            VelumClient.I_field_ab0f6068.warn("Warning: Invalid line format at line {} in {}: {}", new Object[]{n, string2, string});
            return;
        }
        String string3 = string.substring(0, n2).trim();
        String string4 = string.substring(n2 + 1).trim();
        if (string3.isEmpty()) {
            VelumClient.I_field_ab0f6068.warn("Warning: Empty key at line {} in {}", (Object)n, (Object)string2);
            return;
        }
