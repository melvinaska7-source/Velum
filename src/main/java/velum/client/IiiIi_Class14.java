...
import moscow.velum.mixin.accessors.ShaderProgramAccessor;
    ...
    public static void I_method_68ff47d5(boolean bl) {
        for (Runnable runnable : I_field_7865b31) {
            try {
                ...
                System.err.println("[Velum] Failed to (re)load a shader program, skipping: " + String.valueOf(stringBuilder));
            }
        }
    }
}
