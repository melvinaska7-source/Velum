...
import velum.client.iIIIIiiII_Class269;
...
public final class iiiIiii_Class120 {
    ...
    private static final ExecutorService I_field_331d0885 = Executors.newSingleThreadExecutor(runnable -> {
        Thread thread = new Thread(runnable, "Velum-AssetPack");
    ...
    private static void I_method_88f4f220(String string, File file) {
        try {
            ...
            if (bufferedImage == null) {
                VelumClient.I_field_ab0f6068.warn("[Assets] \u043d\u0435 \u043f\u043e\u043d\u044f\u043b \u0444\u043e\u0440\u043c\u0430\u0442 {}", (Object)file);
                return;
            }
            iiiIiii_Class120.I_method_f65f1ff1(string, bufferedImage, VelumClient.id("pack/" + string + ".png"));
        }
        catch (Throwable throwable) {
            VelumClient.I_field_ab0f6068.warn("[Assets] \u043d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c {}: {}", (Object)file, (Object)throwable.toString());
    ...
    private static Identifier I_method_3b1b536e() {
        ...
        I_field_6a3d6525 = identifier = VelumClient.id("pack/fallback.png");
        try (InputStream inputStream = iiiIiii_Class120.class.getResourceAsStream("/assets/velum/image/mainmenu/fallback.jpg");){
            ...
            VelumClient.I_field_ab0f6068.warn("[Assets] \u0432\u0441\u0442\u0440\u043e\u0435\u043d\u043d\u0430\u044f \u0437\u0430\u0433\u043b\u0443\u0448\u043a\u0430 \u043d\u0435 \u043f\u0440\u043e\u0447\u0438\u0442\u0430\u043b\u0430\u0441\u044c: {}", (Object)throwable.toString());
        }
        return identifier;
    }
