...
import velum.client.iIIIIIiII_Class261;
...
extends Module {
    ...
    private final IiIIIiII_Class69<ClientPlayerTickEvent> I_field_3d936f41 = clientPlayerTickEvent -> {
        ...
        VelumClient.getInstance().I_method_58785402().I_method_1acbf705(iiIIiIIii_Class4042, iiIIiIIIi_Class402.Ii_field_32e0c64c, f2, f2, f2, iiIIiIiiI_Class407.iI_field_32efc66c);
        if (VelumClient.getInstance().I_method_58785402().i_method_10b2eeb5().I_method_24e31c97(iiIIiIIii_Class4042) > 1.0f) {
            this.i_field_49 = 0;
            return;
        }
        ...
        if (bl) {
            this.I_field_49 = 0;
            VelumClient.getInstance().I_method_58785402().i_method_3e2418e7(new iiIIiIIii_Class404(AutoPotionModule.I_field_3a9bda27.player.getYaw(), AutoPotionModule.I_field_3a9bda27.player.getPitch()));
        }
    };
