...
import velum.client.IiIIIiIi_Class70;
import velum.client.VelumClient;
import velum.client.iiIIiIiII_Class405;
import velum.client.iiIiIiIii_Class428;
import velum.client.iiIiiIIiI_Class435;
import velum.client.iiIiiiiii_Class448;
import velum.client.iiiIIIiii_Class456;
import velum.client.iiiiIIiIi_Class486;
import velum.client.iiiiIIiii_Class488;
import velum.client.iiiiIiIII_Class489;
import velum.client.iiiiIiIIi_Class490;
...
public final class iiIiiIiIi_Class438 {
    ...
    public IiIIIiIi_Class70 I_method_ab199998() {
        return VelumClient.getInstance().I_method_7897deab();
    }

    public iiIIiIiII_Class405 I_method_762df6b5() {
        return VelumClient.getInstance().I_method_58785402();
    }

    public IIIiiiIi_Class30 I_method_e75201b8() {
        return VelumClient.getInstance().I_method_b4d046cb();
    }
