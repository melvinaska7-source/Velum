...
import moscow.velum.mixin.accessors.TextRendererInvoker;
import moscow.velum.mixin.accessors.TextRendererStyledInvoker;
...
public final class IIIiiIII_Class25 {
    ...
    public static int I_method_694f9124(final TextRenderer textRenderer, final String string, final String string2, final float f, final float f2, final int n, final boolean bl, Matrix4f matrix4f, final TextRenderer.TextLayerType textLayerType, final int n2, final int n3, final boolean bl2) {
        ...
        IIIiIiIi_Class22.I_method_9e8f326c(new IIIiIiIi_Class22.Nested1_85037d53(){
            ...
            public void I_method_2eee247() {
                IIIiiIII_Class25.i_method_a271b12a(() -> textRendererInvoker.velum$drawInternal(string, f, f2, n, bl, matrix4f2, (VertexConsumerProvider)IIIiIiIi_Class22.I_method_93e36b38(), textLayerType, n2, n3, bl2));
            }

            @Override
            public void i_method_2fd6e27() {
                IIIiiIII_Class25.i_method_a271b12a(() -> textRendererInvoker.velum$drawInternal(string2, f, f2, n, bl, matrix4f2, (VertexConsumerProvider)IIIiIiIi_Class22.I_method_93e36b38(), textLayerType, n2, n3, bl2));
            }
        });
    ...
    public static int I_method_cee191d6(final TextRenderer textRenderer, final OrderedText orderedText, final OrderedText orderedText2, final float f, final float f2, final int n, final boolean bl, Matrix4f matrix4f, final TextRenderer.TextLayerType textLayerType, final int n2, final int n3, final boolean bl2) {
        ...
        IIIiIiIi_Class22.I_method_9e8f326c(new IIIiIiIi_Class22.Nested1_85037d53(){
            ...
            @Override
            public void I_method_2eee247() {
                IIIiiIII_Class25.i_method_a271b12a(() -> textRendererStyledInvoker.velum$drawInternal(orderedText, f, f2, n, bl, matrix4f2, (VertexConsumerProvider)IIIiIiIi_Class22.I_method_93e36b38(), textLayerType, n2, n3, bl2));
            }

            @Override
            public void i_method_2fd6e27() {
                IIIiiIII_Class25.i_method_a271b12a(() -> textRendererStyledInvoker.velum$drawInternal(orderedText2, f, f2, n, bl, matrix4f2, (VertexConsumerProvider)IIIiIiIi_Class22.I_method_93e36b38(), textLayerType, n2, n3, bl2));
            }
        });
