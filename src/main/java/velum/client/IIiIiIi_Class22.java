...
import velum.client.iIIiiiI_Class79;
import velum.client.iIiiiIi_Class94;
...
implements iIIiiiI_Class79 {
    ...
    public static JsonObject I_method_48c943bb(IIiIiIi_Class22 iIiIiVelumClient2) {
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("_saveVersion", (Number)1);
        jsonObject.addProperty("expireTimeMs", (Number)iIiIiVelumClient2.I_field_4a);
        jsonObject.addProperty("authorizationHeader", iIiIiVelumClient2.I_field_523beb0a);
        return jsonObject;
    }
    ...
    public boolean equals(Object object) {
        ...
        IIiIiIi_Class22 iIiIiVelumClient2 = (IIiIiIi_Class22)object;
        if (this.I_method_86254473() != iIiIiVelumClient2.I_method_86254473()) {
            return false;
        }
        String string = this.I_method_7bfc2241();
        String string2 = iIiIiVelumClient2.I_method_7bfc2241();
