...
import velum.client.IiIIiIiIi_Class150;
...
import velum.client.iiIIIIIiI_Class387;
    ...
    protected void i_method_bdd4e0ec(III iII) {
        if (!this.I_field_5a) {
            for (MultiSelectSetting.Nested1_42856060 nested1_428560602 : ((MultiSelectSetting)this.I_field_ba11c26c).I_method_45aaa648()) {
                nested1_428560602.setEnablePenis(new iiIIIiiIi_Class398(VelumClient.id("penises/check_enable.penis")));
                nested1_428560602.setDisablePenis(new iiIIIiiIi_Class398(VelumClient.id("penises/check_disable.penis")));
