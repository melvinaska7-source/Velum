...
public final class WindowMenuScreen extends IIiI_Class3 implements IiiIiIIiI_Class211 {
    ...
    public void init() {
        ...
        this.root.I_method_3301fdd(iII_Class5.I_field_b583e68c);
        this.root.IIi_method_4dfc88d7(WIDTH);
        this.root.IiI_method_31d4c97(HEIGHT);
        this.root.I_method_70a38517(10.0F);
        this.root.I_method_f136b1d8((ctx, box) -> {
        ...
        title.height(34.0F).fillWidth();
        title.text(IIiIiI_Class11.II_field_857c0621.I_method_3a2d5e3(10.0F), "Velum",
            c -> IiiiiIIIi_Class242.iI_method_8e08d3b1());
        title.textAlign(IIi_Class2.Ii_field_b5755e8c);
        title.padding(IIII.I_method_14640aa3(8.0F));
        this.root.I_method_8939bffd(title);

        iii_Class8 content = new iii_Class8();
        content.I_method_3301fdd(iII_Class5.II_field_b583e68c);
        content.I_method_70a38517(8.0F);
        content.IiI_method_31d4c97(440.0F);
        content.fillWidth();

        iii_Class8 categories = new iii_Class8();
        categories.I_method_3301fdd(iII_Class5.I_field_b583e68c);
        categories.IIi_method_4dfc88d7(118.0F);
        categories.fillHeight();

        for (ModuleCategory category : ModuleCategory.values()) {
            Iii_Class4 button = new Iii_Class4();
            button.height(27.0F).fillWidth().radius(6.0F).padding(IIII.I_method_14640aa3(6.0F));
            button.text(IIiIiI_Class11.II_field_857c0621.I_method_3a2d5e3(7.0F), category.name(),
                c -> selectedCategory == category
                    ? new ColorRGBA(255.0F, 255.0F, 255.0F, 255.0F)
                    : new ColorRGBA(190.0F, 190.0F, 200.0F, 205.0F));
            button.background(c -> selectedCategory == category
            ...
            categories.I_method_8939bffd(button);
        }

        iii_Class8 moduleColumns = new iii_Class8();
        moduleColumns.I_method_3301fdd(iII_Class5.II_field_b583e68c);
        moduleColumns.fillWidth();
        moduleColumns.fillHeight();

        iii_Class8 col1 = new iii_Class8();
        iii_Class8 col2 = new iii_Class8();
        iii_Class8 col3 = new iii_Class8();
        for (iii_Class8 col : List.of(col1, col2, col3)) {
            col.I_method_3301fdd(iII_Class5.I_field_b583e68c);
            col.fillWidth();
            col.fillHeight();
            moduleColumns.I_method_8939bffd(col);
        }
        ...
        for (ModuleEntry module : modules) {
            ...
            card.background(c -> module.isEnabled()
        ...
        moduleArea.I_method_3301fdd(iII_Class5.I_field_b583e68c);
        moduleArea.fillWidth();
        ...
        settings.I_method_3301fdd(iII_Class5.I_field_b583e68c);
        settings.IIi_method_4dfc88d7(250.0F);
        settings.fillHeight();
        ...
        settings.I_method_8939bffd(settingsTitle);

        for (ModuleEntry module : modules) {
            for (Setting setting : module.getSettings()) {
                iii_Class8 component = setting.createComponent();
                if (component == null) continue;
                component.visibleWhen(() -> selectedModule == module && setting.isVisible());
                settings.I_method_8939bffd(component);
            }
        }
