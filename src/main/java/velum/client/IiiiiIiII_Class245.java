...
import velum.client.IiiiiiIii_Class252;
import velum.client.IiiiiiiII_Class253;
import velum.client.iIIIiIiiI_Class279;
import velum.client.iIIIiiIii_Class284;
import velum.client.iIIIiiiII_Class285;
import velum.client.iIIiIIiIi_Class294;
import velum.client.iIIiIiIIi_Class298;
import velum.client.iIIiiIiII_Class309;
import velum.client.iIIiiIiIi_Class310;
import velum.client.iIIiiiIii_Class316;
import velum.client.iIiIiiIiI_Class347;
...
implements iIIiIIiIi_Class294 {
    ...
    public static Vec3d I_method_34612227(Entity entity, boolean bl) {
        Vec3d vec3d;
        BackTrackModule iiIiiIVelumClient182 = VelumClient.getInstance().getModuleManager().getModule(BackTrackModule.class);
        if (iiIiiIVelumClient182.isEnabled() && entity instanceof iIiIiiIiI_Class347 && (vec3d = iiIiiIVelumClient182.I_method_73e25ed4(entity)) != null) {
            return vec3d;
        }
    ...
    public static float I_method_71f7f60e(LivingEntity livingEntity) {
        ...
        return iIIIiiiII_Class285.Ii_method_b349c526() || iIIIiiiII_Class285.I_method_456510cb(iIIIiiIii_Class284.Iii_field_ac164e6c) || iIIIiiiII_Class285.I_method_dbbac60d("cakeworld") || iIIIiiiII_Class285.I_method_456510cb(iIIIiiIii_Class284.i_field_ac164e6c) || iIIIiiiII_Class285.I_method_456510cb(iIIIiiIii_Class284.I_field_ac164e6c) ? iiIiIIVelumClient102.i_method_bc12845c() : 0.0f;
    }

    public static boolean I_method_94283e23() {
        AuraModule iiIiIIVelumClient102 = VelumClient.getInstance().getModuleManager().getModule(AuraModule.class);
        if (IiiiiiiII_Class253.I_method_59c3e499(0.0, 2.0, 0.0) != Blocks.AIR && IiiiiiiII_Class253.I_method_59c3e499(0.0, -1.0, 0.0) != Blocks.AIR && iIIIiiiII_Class285.I_method_456510cb(iIIIiiIii_Class284.i_field_ac164e6c) && iiIiIIVelumClient102.II_method_c48a1048() % 5 == 0) {
            return false;
        }
    ...
    public static boolean I_method_cd07807a(LivingEntity livingEntity, boolean bl) {
        ...
        AuraModule iiIiIIVelumClient102 = VelumClient.getInstance().getModuleManager().getModule(AuraModule.class);
        CriticalsModule iiIiiIiI_Class2192 = VelumClient.getInstance().getModuleManager().getModule(CriticalsModule.class);
        ...
        return IiiiiIiII_Class245.I_field_3a9bda27.player.isClimbing() || IiiiiIiII_Class245.I_field_3a9bda27.player.isTouchingWater() && IiiiiiiII_Class253.I_method_59c3e499(0.0, 1.0, 0.0) == Blocks.WATER && IiiiiIiII_Class245.I_field_3a9bda27.player.fallDistance <= 0.0f || IiiiiIiII_Class245.I_field_3a9bda27.player.isSwimming() || iiIiiIiI_Class2192.iiI_method_2e239210() || IiiiiIiII_Class245.I_field_3a9bda27.player.isInLava() || iiIiIIVelumClient102.I_method_d5c7315d().isSelected() || IiiiiIiII_Class245.I_field_3a9bda27.player.getAbilities().flying || IiiiiIiII_Class245.I_field_3a9bda27.player.hasStatusEffect(StatusEffects.BLINDNESS) || IiiiiIiII_Class245.I_field_3a9bda27.player.hasStatusEffect(StatusEffects.LEVITATION) || IiiiiIiII_Class245.I_field_3a9bda27.player.hasStatusEffect(StatusEffects.SLOW_FALLING) || IiiiiIiII_Class245.I_field_3a9bda27.player.hasVehicle() || IiiiiIiII_Class245.I_field_3a9bda27.player.fallDistance > IiiiiIiII_Class245.I_method_71f7f60e(livingEntity) && !IiiiiIiII_Class245.I_field_3a9bda27.player.isOnGround() && IiiiiIiII_Class245.I_method_94283e23() || iiIiiIiI_Class2192.iII_method_2c60a1f0() || IiiiiiiII_Class253.I_method_59c3e499(0.0, 2.0, 0.0) != Blocks.AIR && IiiiiiiII_Class253.I_method_59c3e499(0.0, -1.0, 0.0) != Blocks.AIR && iIIIiiiII_Class285.I_method_456510cb(iIIIiiIii_Class284.i_field_ac164e6c) && IiiiiIiII_Class245.I_field_3a9bda27.player.isOnGround() && iiIiIIVelumClient102.II_method_c48a1048() % 5 == 0;
    }
    ...
    public static boolean Ii_method_3b2de85f(LivingEntity livingEntity) {
        ...
        VelumClient.getInstance().I_method_5cb1af22().I_method_20d0f49b(iiiIIII_Class113.I_field_c11fcfcc, IiIiIIII_Class81.I_method_f25a980a("shieldbreaker.title"), IiIiIIII_Class81.I_method_f25a980a("shieldbreaker.desc"));
        return true;
    }
