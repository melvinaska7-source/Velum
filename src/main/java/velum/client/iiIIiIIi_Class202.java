...
public class iiIIiIIi_Class202 {
    ...
    public void i_method_bb7240ac() {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("\u0432\u0441\u0435 \u043d\u0430\u0435\u0431\u043d\u0443\u043b\u043e\u0441\u044c \u0432 dir \u043a\u043e\u043d\u0444\u0438\u0433\u0435 {}", (Object)exception.getMessage());
        }
    }
    ...
    public void I_method_fbe9c396(String string) {
        ...
        if (this.I_method_9c83fef9(string, false) != null) {
            VelumClient.I_field_ab0f6068.warn("Preset {} already exists", (Object)string);
            return;
        }
    ...
    private void iI_method_b2e4cc35() {
        ...
        if (!Files.exists(path2, new LinkOption[0])) {
            try {
                ...
                VelumClient.I_field_ab0f6068.error("\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u0441\u043e\u0437\u0434\u0430\u0442\u044c \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0438\u044e \u043f\u0440\u0435\u0441\u0435\u0442\u043e\u0432: {}", (Object)iOException.getMessage());
                return;
            }
        }
        try (Stream<Path> stream = Files.list(path2);){
            ...
            VelumClient.I_field_ab0f6068.error("\u041e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0441\u043a\u0430\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0438 \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0438\u0438 \u043a\u043e\u043d\u0444\u0438\u0433\u043e\u0432: {}", (Object)iOException.getMessage());
        }
    }
