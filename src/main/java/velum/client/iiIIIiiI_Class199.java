...
import velum.client.iI_Class3;
import velum.client.iIiiiIiII_Class373;
import velum.client.iiIIIIIi_Class194;
import velum.client.iiIIIIiI_Class195;
import velum.client.iiIIIiii_Class200;
...
extends iI_Class3 {
    ...
    protected void i_method_bdd4e0ec(III iII) {
        boolean bl;
        float f;
        iiIIIIIi_Class194 iiIIIIIi_Class1942 = VelumClient.getInstance().I_method_11732eb();
        iiIIiIIi_Class202 iiIIiIVelumClient022 = VelumClient.getInstance().I_method_2da230b();
        List<iiIIiIII_Class201> list = iiIIiIVelumClient022.I_method_43006bfb();
        ...
        float f5 = 0.0f;
        for (iiIIIiii_Class200 object : VelumClient.getInstance().I_method_11732eb().I_method_c2ce901b()) {
    ...
    public void I_method_400ceaa7(double d, double d2, IiIII_Class9 iiIII_Class9) {
        ...
        for (iiIIiIII_Class201 iiIIiIII_Class2012 : new ArrayList<iiIIiIII_Class201>(list)) {
            ...
            if (bl && iIIiIIIiI_Class291.I_method_c3f86263(f2 + 7.0f, f, 6.0, 6.0, d, d2) && iiIII_Class9 == IiIII_Class9.I_field_2f4c8d6c) {
                ...
                if (iiIIiIVelumClient022.i_method_646d600b() != null) {
                    iiIIiIVelumClient022.i_method_646d600b().i_method_84d72ccc();
                }
    ...
    private void i_method_953650ac() {
        ...
        for (Setting iIiiiIIII_Class113 : VelumClient.getInstance().I_method_11732eb().I_method_94b5d40b().getSettings()) {
        ...
        for (Setting iIiiiIIII_Class113 : VelumClient.getInstance().I_method_11732eb().i_method_beb2642b().getSettings()) {
            if (!(iIiiiIIII_Class113 instanceof iiIIIIiI_Class195.Nested1_f8433cb3)) continue;
            nested1_f8433cb3 = (iiIIIIiI_Class195.Nested1_f8433cb3)iIiiiIIII_Class113;
            nested1_f8433cb3.I_method_a1eda161(0.0f);
        }
        iiIIIIIi_Class1942.I_method_d1c7ab76(this.I_field_fdef2cc.I_method_d2579001());
        iiIIiIVelumClient022.I_method_fbe9c396(this.I_field_fdef2cc.I_method_d2579001());
        iiIIiIVelumClient022.I_method_d4b21861(this.I_field_fdef2cc.I_method_d2579001()).I_method_84c8a0ec();
    ...
    public float Ii_method_2047ead7() {
        iiIIiIIi_Class202 iiIIiIVelumClient022 = VelumClient.getInstance().I_method_2da230b();
        List<iiIIiIII_Class201> list = iiIIiIVelumClient022.I_method_43006bfb();
        this.Ii_field_46 = this.i_field_dc7facc.I_method_edd6dd11(Math.min(list.size() * 12 + VelumClient.getInstance().I_method_11732eb().I_method_c2ce901b().size() * 12 - 12, 182) + 46);
