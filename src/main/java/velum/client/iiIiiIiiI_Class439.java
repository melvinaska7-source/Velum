...
import pyvelum.events.newton.NewtonFailedEvent;
import pyvelum.events.newton.NewtonFinishedEvent;
import pyvelum.events.newton.NewtonNodeEvent;
import pyvelum.events.newton.NewtonPathEvent;
import pyvelum.events.newton.NewtonStartedEvent;
import velum.client.IiIIIIIi_Class66;
import velum.client.VelumClient;
import velum.client.iiIiIiiIi_Class430;
import velum.client.iiIiIiiiI_Class431;
import velum.client.iiIiIiiii_Class432;
import velum.client.iiIiiIIII_Class433;
import velum.client.iiIiiIIIi_Class434;
...
public final class iiIiiIiiI_Class439 {
    ...
    private static void I_method_569c1ec0(IiIIIIIi_Class66 iiIIIIIi_Class66) {
        try {
            VelumClient ii_Class2 = VelumClient.getInstance();
