...
public final class iiiIiiII_Class237 {
    ...
    public static Path I_method_db76ec89() {
        return MinecraftClient.getInstance().runDirectory.toPath().resolve("Velum").resolve("neuro");
    }
    ...
    public static boolean i_method_b1962f9a(String string) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[Neuro] \u043d\u0435 \u0437\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u0430\u043a\u0442\u0438\u0432\u043d\u0443\u044e \u043c\u043e\u0434\u0435\u043b\u044c", (Throwable)exception);
        }
    ...
    private static iiiIiiII_Class237 I_method_35285841(String string) {
        try {
            ...
            if (Files.isRegularFile(path, new LinkOption[0])) {
                ...
                try (InputStream inputStream = iiiIiiII_Class237.class.getClassLoader().getResourceAsStream("assets/velum/neuro/default.json");){
                    if (inputStream == null) {
            ...
            VelumClient.I_field_ab0f6068.error("[Neuro] \u043c\u043e\u0434\u0435\u043b\u044c " + string + " \u043d\u0435 \u0447\u0438\u0442\u0430\u0435\u0442\u0441\u044f", (Throwable)exception);
            return null;
        }
    }
