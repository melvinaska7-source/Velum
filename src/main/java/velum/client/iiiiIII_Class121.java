...
import velum.client.iiiIiii_Class120;

public final class iiiiIII_Class121 {
    private static final String I_field_523beb0a = ".velum-assets";
    ...
    public static void I_method_56a08ca9(String string) {
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                VelumClient.I_field_ab0f6068.error("[Assets] \u0443\u0441\u0442\u0430\u043d\u043e\u0432\u043a\u0430 \u043f\u0430\u043a\u0430 \u0441\u043e\u0440\u0432\u0430\u043b\u0430\u0441\u044c", throwable);
            }
            finally {
                I_field_5a = false;
            }
        }, "Velum-AssetPack-Installer");
    ...
    private static void i_method_2757e089(String string) throws Exception {
        ...
        if (Files.isDirectory(path, new LinkOption[0]) && string2.equals(iiiiIII_Class121.I_method_2f0739e1())) {
            VelumClient.I_field_ab0f6068.info("[Assets] \u043f\u0430\u043a \u043d\u0430 \u043c\u0435\u0441\u0442\u0435 \u0438 \u0430\u043a\u0442\u0443\u0430\u043b\u0435\u043d");
            return;
        }
        VelumClient.I_field_ab0f6068.info("[Assets] {} \u043f\u0430\u043a \u043a\u0430\u0440\u0442\u0438\u043d\u043e\u043a ({} \u041c\u0411)...", (Object)(Files.isDirectory(path, new LinkOption[0]) ? "\u043e\u0431\u043d\u043e\u0432\u043b\u044f\u044e" : "\u043a\u0430\u0447\u0430\u044e"), (Object)(Math.max(l, 0L) / 0x100000L));
        ...
        try {
            ...
            if (!string2.equals(string3)) {
                VelumClient.I_field_ab0f6068.error("[Assets] \u0430\u0440\u0445\u0438\u0432 \u043f\u043e\u0431\u0438\u043b\u0441\u044f: \u043e\u0436\u0438\u0434\u0430\u043b\u0438 sha256={}, \u043f\u043e\u043b\u0443\u0447\u0438\u043b\u0438 {}", (Object)string2, (Object)string3);
                return;
            }
            ...
            VelumClient.I_field_ab0f6068.info("[Assets] \u043f\u0430\u043a \u0443\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d: {}", (Object)path);
        }
        finally {
    ...
    private static JsonObject I_method_e9a6e6c5(HttpClient httpClient, String string) {
        ...
        try {
            ...
            if (httpResponse.statusCode() != 200) {
                VelumClient.I_field_ab0f6068.warn("[Assets] \u043c\u0430\u043d\u0438\u0444\u0435\u0441\u0442 \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u0435\u043d (HTTP {}) \u2014 \u043e\u0441\u0442\u0430\u0451\u043c\u0441\u044f \u043d\u0430 \u0432\u0441\u0442\u0440\u043e\u0435\u043d\u043d\u043e\u0439 \u043e\u0431\u043e\u0435", (Object)httpResponse.statusCode());
                return null;
            }
            JsonObject jsonObject = JsonParser.parseString((String)httpResponse.body()).getAsJsonObject();
            if (!jsonObject.has("sha256")) {
                VelumClient.I_field_ab0f6068.warn("[Assets] \u0432 \u043c\u0430\u043d\u0438\u0444\u0435\u0441\u0442\u0435 \u043d\u0435\u0442 sha256 \u2014 \u043f\u0440\u043e\u043f\u0443\u0441\u043a\u0430\u0435\u043c \u0443\u0441\u0442\u0430\u043d\u043e\u0432\u043a\u0443");
                return null;
            }
            return jsonObject;
        }
        catch (Exception exception) {
            VelumClient.I_field_ab0f6068.warn("[Assets] \u043d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043f\u043e\u043b\u0443\u0447\u0438\u0442\u044c \u043c\u0430\u043d\u0438\u0444\u0435\u0441\u0442 ({}): {}", (Object)string2, (Object)exception.getMessage());
            return null;
        }
    }
    ...
    private static String I_method_431692d8(HttpClient httpClient, String string, Path path, long l) throws Exception {
        ...
        try (InputStream inputStream = httpResponse.body();
            ...
            while ((n2 = inputStream.read(byArray)) != -1) {
                ...
                n = n3;
                VelumClient.I_field_ab0f6068.info("[Assets] \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0430: {}%", (Object)n3);
            }
        }
