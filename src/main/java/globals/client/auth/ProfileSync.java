...
import moscow.velum.mixin.accessors.MinecraftClientAccessor;
import net.minecraft.client.MinecraftClient;
import okhttp3.OkHttpClient;
import okhttp3.Request;
import okhttp3.Response;
import velum.client.IiIIIIII_Class65;
...
public final class ProfileSync {
    ...
    private static void apply(JsonObject jsonObject) {
        ...
        Profile.avatarUrl = string3 == null || string3.startsWith("http") ? string3 : "https://velum.pub" + string3;
    ...
    private static void republish() {
        ...
        try {
            IiIIIIII_Class65 iiIIIIII_Class65 = VelumClient.getInstance().I_method_78894eeb();
