...
public final class SessionManager {
   private static final String ENV_HANDOFF = "VELUM_SESSION";
   private static final String PROP_HANDOFF = "velum.session";
   ...
   private static String handoffToken() {
      if (handoffUsed) {
         ...
         String var0 = blankToNull(System.getProperty("velum.session"));
         return var0 != null ? var0 : blankToNull(System.getenv("VELUM_SESSION"));
      }
   }
   ...
   private static void apply(Session var0) {
      ...
      if (var0.username() != null) {
         Information.setPreferUser(new GlobalsUser(var0.username(), null, "Velum".toLowerCase()));
      }
   }
