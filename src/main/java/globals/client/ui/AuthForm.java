    ...
    public void onMouseClicked(double d, double d2, IiIII_Class9 iiIII_Class9) {
        ...
        if (this.login) {
            ...
            if (bl2 && !string.isBlank() && !string2.isBlank()) {
                VelumClient.getInstance().I_method_cd3d46d0().send(new Packets.Nested1_8daaedde(string, string2, "Velum".toLowerCase()));
                Information.setPreferUser(new GlobalsUser(string, string2, "Velum".toLowerCase()));
            }
            ...
            if (bl3 && !string.isBlank() && !string3.isBlank() && !string4.isBlank()) {
                VelumClient.getInstance().I_method_cd3d46d0().send(new Packets.Nested1_6483a00e(string, string3, string4, "Velum".toLowerCase()));
                Information.setPreferUser(new GlobalsUser(string, string4, "Velum".toLowerCase()));
