...
import velum.client.IIiIIIII_Class33;
...
public class PyCommand {
   ...
   public PyCommand install() {
      if (this.root != this) {
         ...
         IIIiiiIi_Class30 var1 = VelumClient.getInstance().I_method_b4d046cb();
   ...
   public boolean remove() {
      if (this.root != this) {
         ...
         VelumClient.getInstance().I_method_b4d046cb().I_method_306252f1(this.registered);
   ...
   private void call(List<Object> var1) {
      if (this.handler != null && (this.owner == null || this.owner.II_method_b18bf526())) {
         try (AutoCloseable var2 = IIiiIIiii_Class104.I_method_5edeb6c9(this.owner)) {
            ...
            VelumClient.I_field_ab0f6068.error("Python error in command '" + this.name + "':", var7);
         }
      }
   }

   private String usage() {
      StringBuilder var1 = new StringBuilder(VelumClient.getInstance().I_method_b4d046cb().I_method_80ea594()).append(this.name);
