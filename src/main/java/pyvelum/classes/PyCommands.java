...
public class PyCommands {
    ...
    public boolean exists(String string) {
        ...
        for (IIIiiIIi_Class26 iIIiiIVelumClient6 : PyCommands.registry().I_method_cafa303b()) {
            for (String string2 : iIIiiIVelumClient6.I_method_84c7081b()) {
    ...
    public List<String> names() {
        ...
        for (IIIiiIIi_Class26 iIIiiIVelumClient6 : PyCommands.registry().I_method_cafa303b()) {
            if (iIIiiIVelumClient6.I_method_84c7081b().isEmpty()) continue;
            arrayList.add(iIIiiIVelumClient6.I_method_84c7081b().getFirst());
        }
        return arrayList;
    }
