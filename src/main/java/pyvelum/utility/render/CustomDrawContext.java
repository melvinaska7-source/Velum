package pyvelum.utility.render;
...
import velum.client.IIiiII_Class13;
...
import velum.client.iiIIIiIII_Class393;
...
implements iIIiIIiIi_Class294 {
    ...
    public void drawRocknetGlass(Rect rect, float f, float f2, float f3, float f4, float f5, float f6, IIiii_Class8 iIiii_Class8, boolean bl) {
        ...
        AbstractTexture abstractTexture = textureManager.getTexture(VelumClient.id(bl ? "rocknet/background.png" : "rocknet/blur.png"));
    ...
    public void drawIcon(String string, float f, float f2, float f3, ColorRGBA colorRGBA) {
        ...
        if (n == null) {
            ...
            this.drawTexture(VelumClient.id((String)object), f, f2, f3, f3, colorRGBA);
            return;
        }
