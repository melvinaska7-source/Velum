...
import pyvelum.ui.Node;
import pyvelum.ui.Ui;
import velum.client.III;
import velum.client.IIiI_Class3;
...
extends IIiI_Class3 {
    ...
    public void init() {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[PyScreen] build error", (Throwable)exception);
        }
    }
    ...
    public void afterRender(III iII) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[PyScreen] immediate render error", (Throwable)exception);
        }
    }
    ...
    public void onMouseClicked(double d, double d2, IiIII_Class9 iiIII_Class9) {
        ...
        if (this.clickCb != null) {
            try {
                ...
                VelumClient.I_field_ab0f6068.error("[PyScreen] click error", (Throwable)exception);
            }
        }
    }
    ...
    public void onMouseReleased(double d, double d2, IiIII_Class9 iiIII_Class9) {
        ...
        if (this.releaseCb != null) {
            try {
                ...
                VelumClient.I_field_ab0f6068.error("[PyScreen] release error", (Throwable)exception);
            }
        }
    }
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[PyScreen] key press error", (Throwable)exception);
        }
        return true;
    }
    ...
    public boolean keyReleased(int keyCode, int scanCode, int modifiers) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[PyScreen] key release error", (Throwable)exception);
        }
        return true;
    }
    ...
    public void mouseMoved(double mouseX, double mouseY) {
        ...
        try {
            ...
            VelumClient.I_field_ab0f6068.error("[PyScreen] mouse move error", (Throwable)exception);
        }
    }
