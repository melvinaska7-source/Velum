...
import pyvelum.classes.PyDynamicIsland;
import pyvelum.classes.PyModule;
import pyvelum.classes.PyMusic;
import pyvelum.classes.settings.PyBooleanSetting;
import pyvelum.classes.settings.PyButtonSetting;
import pyvelum.classes.settings.PyColorSetting;
import pyvelum.classes.settings.PyModeSetting;
import pyvelum.classes.settings.PyRangeSetting;
import pyvelum.classes.settings.PySelectSetting;
import pyvelum.classes.settings.PySliderSetting;
...
import velum.client.IiiIiIIiI_Class211;
...
public class Client {
   ...
   public Object find(String var1, String var2) {
      ModuleEntry var3;
      try {
         var3 = VelumClient.getInstance().getModuleManager().getModuleByName(var1);
   ...
   public List<PyModule> modules() {
      return VelumClient.getInstance().getModuleManager().getModules().stream().map(PyModule::new).toList();
   }
