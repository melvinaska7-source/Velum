...
import velum.client.iIiIi_Class22;
...
public final class GlowRenderLayers {
    ...
    public static void initShader(iIiIi_Class22 iIiVelumClient22) {
        glowProgram = iIiVelumClient22.I_method_bbcba39();
        CACHE.clear();
    }
    ...
    private static RenderLayer create(Identifier identifier) {
        ...
        return RenderLayer.of((String)"velum_glow_entity", (VertexFormat)VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, (VertexFormat.DrawMode)VertexFormat.DrawMode.QUADS, (int)1536, (boolean)true, (boolean)false, (RenderLayer.MultiPhaseParameters)multiPhaseParameters);
    }
}
